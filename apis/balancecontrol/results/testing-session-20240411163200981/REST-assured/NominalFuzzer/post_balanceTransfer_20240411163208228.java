...
@Order(77)
public class post_balanceTransfer_20240411163208228{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_value = 5;
		...
		Object request0_request_body_fromMerchant = "modi op. uv";
		...
		Object request0_request_body_toMerchant = "Lipman";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "a";
	...
	@Test
	public void test_post_balanceTransfer_20240411163208228()  throws JSONException{
		test0();
	}
}
