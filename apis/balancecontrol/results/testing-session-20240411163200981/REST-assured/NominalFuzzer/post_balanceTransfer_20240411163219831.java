...
@Order(186)
public class post_balanceTransfer_20240411163219831{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "HR37 8702 9534 1002 4760 0";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 5322572758081056695;
		...
		Object request0_request_body_fromMerchant = "107.37.98.151";
		request0_request_body.put("fromMerchant" , request0_request_body_fromMerchant);
		Object request0_request_body_reference = "unoppignorated";
		request0_request_body.put("reference" , request0_request_body_reference);
		Object request0_request_body_toMerchant = "N.";
	...
	@Test
	public void test_post_balanceTransfer_20240411163219831()  throws JSONException{
		test0();
	}
}
