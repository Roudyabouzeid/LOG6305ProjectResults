...
@Order(7)
public class post_balanceTransfer_20240411163201295{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "Z 2";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 1374789976086951980;
		...
		Object request0_request_body_fromMerchant = "Gustave ";
		...
		Object request0_request_body_toMerchant = "AUP";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "madderish";
	...
	@Test
	public void test_post_balanceTransfer_20240411163201295()  throws JSONException{
		test0();
	}
}
