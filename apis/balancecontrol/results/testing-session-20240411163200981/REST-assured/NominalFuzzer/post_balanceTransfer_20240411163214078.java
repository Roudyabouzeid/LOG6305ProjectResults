...
@Order(132)
public class post_balanceTransfer_20240411163214078{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "E B";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 1416078282326909177;
		...
		Object request0_request_body_fromMerchant = "6973754604";
		...
		Object request0_request_body_toMerchant = "sublethally";
	...
	@Test
	public void test_post_balanceTransfer_20240411163214078()  throws JSONException{
		test0();
	}
}
