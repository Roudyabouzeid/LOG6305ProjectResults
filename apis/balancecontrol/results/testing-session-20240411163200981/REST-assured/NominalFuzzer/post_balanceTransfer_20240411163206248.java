...
@Order(53)
public class post_balanceTransfer_20240411163206248{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "m I";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 92;
		...
		Object request0_request_body_fromMerchant = "clinicopathological";
		...
		Object request0_request_body_toMerchant = "ar";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "full-sphered";
	...
	@Test
	public void test_post_balanceTransfer_20240411163206248()  throws JSONException{
		test0();
	}
}
