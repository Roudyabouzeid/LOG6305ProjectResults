...
@Order(163)
public class post_balanceTransfer_20240411163217919{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "SUN";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 48;
		...
		Object request0_request_body_fromMerchant = "kelotomy";
		...
		Object request0_request_body_toMerchant = "demeritoriously";
	...
	@Test
	public void test_post_balanceTransfer_20240411163217919()  throws JSONException{
		test0();
	}
}
