...
@Order(153)
public class post_balanceTransfer_20240411163216009{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "uva";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 18;
		...
		Object request0_request_body_fromMerchant = "pp@gvqiupx.co.uk";
		...
		Object request0_request_body_toMerchant = "PAT";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "L ";
	...
	@Test
	public void test_post_balanceTransfer_20240411163216009()  throws JSONException{
		test0();
	}
}
