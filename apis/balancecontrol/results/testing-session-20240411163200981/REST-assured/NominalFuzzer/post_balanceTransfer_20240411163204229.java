...
@Order(27)
public class post_balanceTransfer_20240411163204229{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "bks";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 63;
		...
		Object request0_request_body_description = "c4874e73-1a22-49bb-afa3-1f01488943b0";
		request0_request_body.put("description" , request0_request_body_description);
		Object request0_request_body_fromMerchant = "233-871377";
		...
		Object request0_request_body_toMerchant = "0013 7672900";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "judicatory";
	...
	@Test
	public void test_post_balanceTransfer_20240411163204229()  throws JSONException{
		test0();
	}
}
