...
@Order(51)
public class post_balanceTransfer_20240411163206244{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "+7006 76659570405";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 2;
		...
		Object request0_request_body_fromMerchant = "FD";
		...
		Object request0_request_body_toMerchant = "Wobbly";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "BR62 0845 1763 2889 6497 9974 094P D";
	...
	@Test
	public void test_post_balanceTransfer_20240411163206244()  throws JSONException{
		test0();
	}
}
