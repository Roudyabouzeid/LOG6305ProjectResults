...
@Order(129)
public class post_balanceTransfer_20240411163214074{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "mau";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 41;
		...
		Object request0_request_body_fromMerchant = "tineman";
		...
		Object request0_request_body_toMerchant = "heavy-blossomed MSB thuoc HK";
	...
	@Test
	public void test_post_balanceTransfer_20240411163214074()  throws JSONException{
		test0();
	}
}
