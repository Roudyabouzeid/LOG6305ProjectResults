...
@Order(117)
public class post_balanceTransfer_20240411163212146{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "VMD";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 100;
		...
		Object request0_request_body_fromMerchant = "deadeyes";
		request0_request_body.put("fromMerchant" , request0_request_body_fromMerchant);
		Object request0_request_body_reference = "AU";
		request0_request_body.put("reference" , request0_request_body_reference);
		Object request0_request_body_toMerchant = "synagogism";
	...
	@Test
	public void test_post_balanceTransfer_20240411163212146()  throws JSONException{
		test0();
	}
}
