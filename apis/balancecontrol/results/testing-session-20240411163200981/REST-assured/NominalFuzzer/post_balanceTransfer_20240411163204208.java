...
@Order(21)
public class post_balanceTransfer_20240411163204208{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "dk.";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 4350652432327651161;
		...
		Object request0_request_body_description = "NDIS";
		request0_request_body.put("description" , request0_request_body_description);
		Object request0_request_body_fromMerchant = "hydrobiosis";
		...
		Object request0_request_body_toMerchant = "FAO";
	...
	@Test
	public void test_post_balanceTransfer_20240411163204208()  throws JSONException{
		test0();
	}
}
