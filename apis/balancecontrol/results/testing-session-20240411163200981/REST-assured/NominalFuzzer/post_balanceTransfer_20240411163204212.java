...
@Order(22)
public class post_balanceTransfer_20240411163204212{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "b7b4:60ee:d49c:4d41:d791:9941:05ad:4d8c";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -1406620384372998745;
		...
		Object request0_request_body_fromMerchant = "X";
		...
		Object request0_request_body_toMerchant = "730-593162";
	...
	@Test
	public void test_post_balanceTransfer_20240411163204212()  throws JSONException{
		test0();
	}
}
