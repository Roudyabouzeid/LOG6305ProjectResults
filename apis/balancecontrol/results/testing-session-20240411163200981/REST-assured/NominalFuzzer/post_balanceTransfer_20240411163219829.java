...
@Order(185)
public class post_balanceTransfer_20240411163219829{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_value = 25;
		...
		Object request0_request_body_fromMerchant = "DJ";
		request0_request_body.put("fromMerchant" , request0_request_body_fromMerchant);
		Object request0_request_body_reference = "deep-troubled";
		request0_request_body.put("reference" , request0_request_body_reference);
		Object request0_request_body_toMerchant = "blocking";
	...
	@Test
	public void test_post_balanceTransfer_20240411163219829()  throws JSONException{
		test0();
	}
}
