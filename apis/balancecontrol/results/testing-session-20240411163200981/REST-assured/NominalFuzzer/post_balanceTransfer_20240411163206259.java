...
@Order(58)
public class post_balanceTransfer_20240411163206259{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "PBT";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -3874773338110170967;
		...
		Object request0_request_body_fromMerchant = "2";
		...
		Object request0_request_body_toMerchant = "TF54 9859 5396 94BA NQW4 KZLS 961";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "FR69 8266 3447 83VG XB2E PSTS N14";
	...
	@Test
	public void test_post_balanceTransfer_20240411163206259()  throws JSONException{
		test0();
	}
}
