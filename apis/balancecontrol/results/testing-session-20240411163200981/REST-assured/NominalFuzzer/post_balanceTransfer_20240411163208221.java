...
@Order(74)
public class post_balanceTransfer_20240411163208221{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "+687479457200724";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 17;
		...
		Object request0_request_body_fromMerchant = "sulphopropionic";
		...
		Object request0_request_body_toMerchant = "e8a6:456e:e595:69b8:8230:02ee:3217:14f1";
	...
	@Test
	public void test_post_balanceTransfer_20240411163208221()  throws JSONException{
		test0();
	}
}
