...
@Order(187)
public class post_balanceTransfer_20240411163219832{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "AT51 9830 3748 8106 6983";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -349726955812962068;
		...
		Object request0_request_body_fromMerchant = "Lxk0b";
		...
		Object request0_request_body_toMerchant = "2001/07/28";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "photodisintegrate";
	...
	@Test
	public void test_post_balanceTransfer_20240411163219832()  throws JSONException{
		test0();
	}
}
