...
@Order(133)
public class post_balanceTransfer_20240411163214079{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_value = 4835671667377271210;
		...
		Object request0_request_body_fromMerchant = "2009/10/17";
		request0_request_body.put("fromMerchant" , request0_request_body_fromMerchant);
		Object request0_request_body_reference = "self-advancing";
		request0_request_body.put("reference" , request0_request_body_reference);
		Object request0_request_body_toMerchant = "O'";
	...
	@Test
	public void test_post_balanceTransfer_20240411163214079()  throws JSONException{
		test0();
	}
}
