...
@Order(24)
public class post_balanceTransfer_20240411163204219{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_value = -1087164959522324589;
		...
		Object request0_request_body_fromMerchant = "Inanna";
		request0_request_body.put("fromMerchant" , request0_request_body_fromMerchant);
		Object request0_request_body_reference = "tchu X";
		request0_request_body.put("reference" , request0_request_body_reference);
		Object request0_request_body_toMerchant = "H twice-copyrighte";
	...
	@Test
	public void test_post_balanceTransfer_20240411163204219()  throws JSONException{
		test0();
	}
}
