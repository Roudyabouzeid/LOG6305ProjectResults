...
@Order(154)
public class post_balanceTransfer_20240411163216011{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "http://ypsrwbjfu.orc.gov/fur-coated/";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 85;
		...
		Object request0_request_body_fromMerchant = "B";
		...
		Object request0_request_body_toMerchant = "c43";
	...
	@Test
	public void test_post_balanceTransfer_20240411163216011()  throws JSONException{
		test0();
	}
}
