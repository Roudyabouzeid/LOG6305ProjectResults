...
@Order(181)
public class post_balanceTransfer_20240411163219826{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "00012602311";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -9067829153080368063;
		...
		Object request0_request_body_description = "Harz";
		request0_request_body.put("description" , request0_request_body_description);
		Object request0_request_body_fromMerchant = "noncontending";
		...
		Object request0_request_body_toMerchant = "mMcmcTBJHuc9yoe_VL5J-Xg9zBmWQImTXSvY1L9-89ieeSQ=";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "terminalSale";
	...
	@Test
	public void test_post_balanceTransfer_20240411163219826()  throws JSONException{
		test0();
	}
}
