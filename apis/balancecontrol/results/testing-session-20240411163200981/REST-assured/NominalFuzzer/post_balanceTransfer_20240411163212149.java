...
@Order(120)
public class post_balanceTransfer_20240411163212149{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_fromMerchant = "http://gwvvwfwi.rxwojnwje.it/";
		request0_request_body.put("fromMerchant" , request0_request_body_fromMerchant);
		Object request0_request_body_reference = "tended";
		request0_request_body.put("reference" , request0_request_body_reference);
		Object request0_request_body_toMerchant = "NU";
	...
	@Test
	public void test_post_balanceTransfer_20240411163212149()  throws JSONException{
		test0();
	}
}
