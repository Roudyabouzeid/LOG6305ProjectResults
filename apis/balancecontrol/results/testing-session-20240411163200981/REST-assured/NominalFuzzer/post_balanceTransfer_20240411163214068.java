...
@Order(124)
public class post_balanceTransfer_20240411163214068{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "LBjrrc5ZONSC6j4NrB5FhVBWOz_YzL41nqzdNJEIgzZ14w6SikesWV05Hs7pF3Uh5wzt1g==";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -5390323665693096769;
		...
		Object request0_request_body_description = "+7800 50213839021";
		request0_request_body.put("description" , request0_request_body_description);
		Object request0_request_body_fromMerchant = "cunit";
		...
		Object request0_request_body_toMerchant = "benighted";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "MSRURNahkkYKDgYETwFy5Cy6s-5CDgpaPKWpYvgmnDKyBegZZ6mr-TYdYHKAQiwd_g==";
	...
	@Test
	public void test_post_balanceTransfer_20240411163214068()  throws JSONException{
		test0();
	}
}
