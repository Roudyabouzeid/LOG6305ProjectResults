...
@Order(13)
public class post_balanceTransfer_20240411163201334{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_value = 96;
		...
		Object request0_request_body_fromMerchant = "twice-endorsed";
		request0_request_body.put("fromMerchant" , request0_request_body_fromMerchant);
		Object request0_request_body_reference = "1485624968";
		request0_request_body.put("reference" , request0_request_body_reference);
		Object request0_request_body_toMerchant = "gIvw5GiXCpYkn9K";
	...
	@Test
	public void test_post_balanceTransfer_20240411163201334()  throws JSONException{
		test0();
	}
}
