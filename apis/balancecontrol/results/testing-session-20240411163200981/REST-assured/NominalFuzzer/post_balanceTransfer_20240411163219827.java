...
@Order(182)
public class post_balanceTransfer_20240411163219827{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "OMS";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 14;
		...
		Object request0_request_body_description = "7a8XD6wA0OM=";
		request0_request_body.put("description" , request0_request_body_description);
		Object request0_request_body_fromMerchant = "http://xqibjrzd.co.uk/";
		...
		Object request0_request_body_toMerchant = "AP";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "triunification";
	...
	@Test
	public void test_post_balanceTransfer_20240411163219827()  throws JSONException{
		test0();
	}
}
