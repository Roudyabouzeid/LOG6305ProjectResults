...
@Order(10)
public class post_balanceTransfer_20240411163201315{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "BYU";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -837526580355400591;
		...
		Object request0_request_body_reference = "well-counterfeited";
		request0_request_body.put("reference" , request0_request_body_reference);
		Object request0_request_body_toMerchant = "Adams";
	...
	@Test
	public void test_post_balanceTransfer_20240411163201315()  throws JSONException{
		test0();
	}
}
