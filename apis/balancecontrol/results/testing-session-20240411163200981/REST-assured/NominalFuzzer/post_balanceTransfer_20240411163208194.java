...
@Order(64)
public class post_balanceTransfer_20240411163208194{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "BCE";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -736116626545802653;
		...
		Object request0_request_body_fromMerchant = "photoluminescents";
		request0_request_body.put("fromMerchant" , request0_request_body_fromMerchant);
		Object request0_request_body_reference = "23:24:05";
		request0_request_body.put("reference" , request0_request_body_reference);
		Object request0_request_body_toMerchant = "Shig";
	...
	@Test
	public void test_post_balanceTransfer_20240411163208194()  throws JSONException{
		test0();
	}
}
