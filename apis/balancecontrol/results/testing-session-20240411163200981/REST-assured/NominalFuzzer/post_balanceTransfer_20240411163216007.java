...
@Order(152)
public class post_balanceTransfer_20240411163216007{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "Oph";
		...
		Object request0_request_body_fromMerchant = "outfish";
		request0_request_body.put("fromMerchant" , request0_request_body_fromMerchant);
		Object request0_request_body_reference = "KW94 LCVX FH7J 17J7 IYK5 04R8 P1HS YB";
		request0_request_body.put("reference" , request0_request_body_reference);
		Object request0_request_body_toMerchant = "livelong";
	...
	@Test
	public void test_post_balanceTransfer_20240411163216007()  throws JSONException{
		test0();
	}
}
