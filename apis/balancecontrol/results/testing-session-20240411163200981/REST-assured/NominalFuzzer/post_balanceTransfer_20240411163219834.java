...
@Order(189)
public class post_balanceTransfer_20240411163219834{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "2006/07/21";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 8082937209762524968;
		...
		Object request0_request_body_toMerchant = "2004/06/20";
	...
	@Test
	public void test_post_balanceTransfer_20240411163219834()  throws JSONException{
		test0();
	}
}
