...
@Order(67)
public class post_balanceTransfer_20240411163208205{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_value = -6653014453856060596;
		...
		Object request0_request_body_fromMerchant = "PT60 8437 6943 3670 6355 5029 4";
		request0_request_body.put("fromMerchant" , request0_request_body_fromMerchant);
		Object request0_request_body_reference = "NNTPzEBQ61DlkT";
		request0_request_body.put("reference" , request0_request_body_reference);
		Object request0_request_body_toMerchant = "bradenhead";
	...
	@Test
	public void test_post_balanceTransfer_20240411163208205()  throws JSONException{
		test0();
	}
}
