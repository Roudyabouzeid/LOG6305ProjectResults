...
@Order(95)
public class post_balanceTransfer_20240411163210193{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "CGE";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 37;
		...
		Object request0_request_body_fromMerchant = "traffic-congested";
		...
		Object request0_request_body_toMerchant = "crispil";
	...
	@Test
	public void test_post_balanceTransfer_20240411163210193()  throws JSONException{
		test0();
	}
}
