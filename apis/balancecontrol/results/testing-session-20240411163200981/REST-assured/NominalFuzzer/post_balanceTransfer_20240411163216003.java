...
@Order(150)
public class post_balanceTransfer_20240411163216003{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "NPG";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 109;
		...
		Object request0_request_body_fromMerchant = "http://bes.com/pyrognomic/";
		...
		Object request0_request_body_toMerchant = "XO";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "eb8ce8e5-631b-41bf-81c6-74514510fa7b";
	...
	@Test
	public void test_post_balanceTransfer_20240411163216003()  throws JSONException{
		test0();
	}
}
