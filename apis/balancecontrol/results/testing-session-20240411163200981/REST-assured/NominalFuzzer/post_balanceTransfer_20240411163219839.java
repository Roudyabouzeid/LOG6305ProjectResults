...
@Order(194)
public class post_balanceTransfer_20240411163219839{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "udphcvs@live.com";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 71;
		...
		Object request0_request_body_fromMerchant = "jqZ";
		...
		Object request0_request_body_toMerchant = "monopitch";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "squinance";
	...
	@Test
	public void test_post_balanceTransfer_20240411163219839()  throws JSONException{
		test0();
	}
}
