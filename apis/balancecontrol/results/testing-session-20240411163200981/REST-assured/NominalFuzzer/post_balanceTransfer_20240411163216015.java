...
@Order(156)
public class post_balanceTransfer_20240411163216015{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "http://bypmh.lmndhbc.me/aUOoWbdak5/";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 45;
		...
		Object request0_request_body_fromMerchant = "subpeduncled";
		...
		Object request0_request_body_toMerchant = "VUIT";
	...
	@Test
	public void test_post_balanceTransfer_20240411163216015()  throws JSONException{
		test0();
	}
}
