...
@Order(90)
public class post_balanceTransfer_20240411163210181{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "Ula";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -6282510232918946238;
		...
		Object request0_request_body_fromMerchant = "+403995784889211";
		request0_request_body.put("fromMerchant" , request0_request_body_fromMerchant);
		Object request0_request_body_reference = "64fbfb27-98d2-4762-83b1-cf3f3eb3212c";
		request0_request_body.put("reference" , request0_request_body_reference);
		Object request0_request_body_toMerchant = "otorhinolaryngology";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "credit";
	...
	@Test
	public void test_post_balanceTransfer_20240411163210181()  throws JSONException{
		test0();
	}
}
