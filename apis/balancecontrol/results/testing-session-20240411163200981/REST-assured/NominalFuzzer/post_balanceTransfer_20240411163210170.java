...
@Order(85)
public class post_balanceTransfer_20240411163210170{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "7b3b:6156:837d:9926:4e7d:5025:e50c:c540";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 2072472209035657140;
		...
		Object request0_request_body_fromMerchant = "nonexcessively";
		...
		Object request0_request_body_toMerchant = "neuropsychologist";
	...
	@Test
	public void test_post_balanceTransfer_20240411163210170()  throws JSONException{
		test0();
	}
}
