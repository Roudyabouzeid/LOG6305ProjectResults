...
@Order(94)
public class post_balanceTransfer_20240411163210190{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "ary";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -1323133416864348187;
		...
		Object request0_request_body_description = "Prussianization";
		request0_request_body.put("description" , request0_request_body_description);
		Object request0_request_body_fromMerchant = "thuoc";
		...
		Object request0_request_body_toMerchant = "tarrish";
	...
	@Test
	public void test_post_balanceTransfer_20240411163210190()  throws JSONException{
		test0();
	}
}
