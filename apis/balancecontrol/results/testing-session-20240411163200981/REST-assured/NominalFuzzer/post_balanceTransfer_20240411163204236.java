...
@Order(30)
public class post_balanceTransfer_20240411163204236{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "a8b0ec50-7d8f-49eb-bc7f-9ea482e5b5ee";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 8538593253008665472;
		...
		Object request0_request_body_description = "652f3222-7a8c-40e1-a824-2c07ab9efa72";
		request0_request_body.put("description" , request0_request_body_description);
		Object request0_request_body_fromMerchant = "hwyl";
		...
		Object request0_request_body_toMerchant = "treetops";
		request0_request_body.put("toMerchant" , request0_request_body_toMerchant);
		Object request0_request_body_type = "tax";
	...
	@Test
	public void test_post_balanceTransfer_20240411163204236()  throws JSONException{
		test0();
	}
}
