...
@Order(73)
public class post_balanceTransfer_20240411163208219{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "njzdcnsn@y.info";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 40;
		...
		Object request0_request_body_fromMerchant = "devaluation";
		request0_request_body.put("fromMerchant" , request0_request_body_fromMerchant);
		Object request0_request_body_reference = "zoopathy";
		request0_request_body.put("reference" , request0_request_body_reference);
		Object request0_request_body_toMerchant = "XwS6UV07Yt7SlXM@DL";
	...
	@Test
	public void test_post_balanceTransfer_20240411163208219()  throws JSONException{
		test0();
	}
}
