...
@Order(91)
public class post_balanceTransfer_20240411163210183{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "wbqxlknw@mavtoi.me";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -6593718655093999611;
		...
		Object request0_request_body_fromMerchant = "EAEO";
		...
		Object request0_request_body_toMerchant = "e7cbb85c-3182-456b-881b-0cf237c4503b";
	...
	@Test
	public void test_post_balanceTransfer_20240411163210183()  throws JSONException{
		test0();
	}
}
