...
@Order(48)
public class post_balanceTransfer_20240411163206237{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BalanceControl/v1";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "9292165271";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -32698287167783230;
		...
		Object request0_request_body_fromMerchant = "Nu";
		...
		Object request0_request_body_toMerchant = "+6876 89553554421";
	...
	@Test
	public void test_post_balanceTransfer_20240411163206237()  throws JSONException{
		test0();
	}
}
