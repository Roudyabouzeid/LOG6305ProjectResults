...
@Order(61)
public class post_getCostEstimate_20240411163447350{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_value = 95;
		...
		Object request0_request_body_encryptedCardNumber = "Moorefield";
		request0_request_body.put("encryptedCardNumber" , request0_request_body_encryptedCardNumber);
		Object request0_request_body_merchantAccount = "Yao hogget";
		...
		Object request0_request_body_selectedRecurringDetailReference = "belfr";
		request0_request_body.put("selectedRecurringDetailReference" , request0_request_body_selectedRecurringDetailReference);
		Object request0_request_body_shopperInteraction = "ContAuth";
	...
	@Test
	public void test_post_getCostEstimate_20240411163447350()  throws JSONException{
		test0();
	}
}
