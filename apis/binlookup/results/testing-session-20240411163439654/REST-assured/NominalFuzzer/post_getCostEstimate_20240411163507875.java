...
@Order(269)
public class post_getCostEstimate_20240411163507875{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "PAT";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 60;
		...
		Object request0_request_body_encryptedCardNumber = "twice-sacrificed";
		request0_request_body.put("encryptedCardNumber" , request0_request_body_encryptedCardNumber);
		Object request0_request_body_merchantAccount = "Dixie e";
		...
		Object request0_request_body_recurring_recurringDetailName = "Proto-Indo-European";
		...
		Object request0_request_body_recurring_recurringFrequency = "0ede:cccd:9964:6a64:eff3:04fd:086b:eb74";
	...
	@Test
	public void test_post_getCostEstimate_20240411163507875()  throws JSONException{
		test0();
	}
}
