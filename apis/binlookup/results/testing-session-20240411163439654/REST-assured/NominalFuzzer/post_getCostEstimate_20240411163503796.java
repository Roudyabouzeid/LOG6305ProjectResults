...
@Order(222)
public class post_getCostEstimate_20240411163503796{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "ecb";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 43;
		...
		Object request0_request_body_merchantAccount = "d12cf809a80ccea";
		...
		Object request0_request_body_merchantDetails_countryCode = "XN";
		...
		Object request0_request_body_recurring_recurringFrequency = "overabundances";
	...
	@Test
	public void test_post_getCostEstimate_20240411163503796()  throws JSONException{
		test0();
	}
}
