...
@Order(302)
public class post_getCostEstimate_20240411163511925{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "LC15 JBZP AT9U 0A5A XGIX MZQ0 1PE8 0DEU";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 9007066151114364925;
		...
		Object request0_request_body_merchantAccount = "Maja";
		...
		Object request0_request_body_recurring_recurringExpiry = "2019/10/10 21:55:44";
		request0_request_body_recurring.put("recurringExpiry" , request0_request_body_recurring_recurringExpiry);
		Object request0_request_body_recurring_recurringFrequency = "QUda2";
	...
	@Test
	public void test_post_getCostEstimate_20240411163511925()  throws JSONException{
		test0();
	}
}
