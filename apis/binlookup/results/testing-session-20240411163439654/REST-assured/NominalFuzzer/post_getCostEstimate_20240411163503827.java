...
@Order(237)
public class post_getCostEstimate_20240411163503827{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "NFT";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 1696777332545449923;
		...
		Object request0_request_body_assumptions_assume3DSecureAuthenticated = false;
		...
		Object request0_request_body_merchantAccount = "valerate";
		...
		Object request0_request_body_merchantDetails_countryCode = "DN";
		...
		Object request0_request_body_selectedRecurringDetailReference = "RB";
	...
	@Test
	public void test_post_getCostEstimate_20240411163503827()  throws JSONException{
		test0();
	}
}
