...
@Order(103)
public class post_getCostEstimate_20240411163451466{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "2010/09/04";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -216714580227966507;
		...
		Object request0_request_body_merchantAccount = "superstructral";
	...
	@Test
	public void test_post_getCostEstimate_20240411163451466()  throws JSONException{
		test0();
	}
}
