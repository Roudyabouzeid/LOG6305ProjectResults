...
@Order(23)
public class post_getCostEstimate_20240411163442929{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "3740384929";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 47;
		...
		Object request0_request_body_encryptedCardNumber = "aftershine";
		request0_request_body.put("encryptedCardNumber" , request0_request_body_encryptedCardNumber);
		Object request0_request_body_merchantAccount = "8b8f:3aee:0991:4253:687b:2388:fa39:17b0";
		...
		Object request0_request_body_recurring_recurringDetailName = "snuff";
		...
		Object request0_request_body_selectedRecurringDetailReference = "well-counterfeited";
	...
	@Test
	public void test_post_getCostEstimate_20240411163442929()  throws JSONException{
		test0();
	}
}
