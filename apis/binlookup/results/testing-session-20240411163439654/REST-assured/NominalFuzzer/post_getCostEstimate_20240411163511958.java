...
@Order(317)
public class post_getCostEstimate_20240411163511958{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "NMI";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 107;
		...
		Object request0_request_body_merchantAccount = "L nonhedonistically N";
		...
		Object request0_request_body_merchantDetails_mcc = "semiobjective oystere";
		...
		Object request0_request_body_recurring_recurringDetailName = "proclamatory";
	...
	@Test
	public void test_post_getCostEstimate_20240411163511958()  throws JSONException{
		test0();
	}
}
