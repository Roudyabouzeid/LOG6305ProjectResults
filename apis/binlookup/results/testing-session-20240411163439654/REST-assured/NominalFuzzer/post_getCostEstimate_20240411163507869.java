...
@Order(266)
public class post_getCostEstimate_20240411163507869{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "B X";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 5299512515529875713;
		...
		Object request0_request_body_merchantAccount = "whv@live.com";
	...
	@Test
	public void test_post_getCostEstimate_20240411163507869()  throws JSONException{
		test0();
	}
}
