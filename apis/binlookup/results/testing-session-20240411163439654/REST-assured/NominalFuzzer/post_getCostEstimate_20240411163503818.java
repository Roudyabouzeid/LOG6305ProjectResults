...
@Order(233)
public class post_getCostEstimate_20240411163503818{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "Vee";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 7397915207540484964;
		...
		Object request0_request_body_merchantAccount = "lpgbBCF1PAXtdu4qiA-CwS8ipAYxwhiAFvzgmVBLMU12_ybpP7eW6qaRnmfc_FwJzE2uWdHxtg1plBp8eGe-0ZimXuwn";
		...
		Object request0_request_body_merchantDetails_mcc = "codfishes douc Nyx Q ";
		...
		Object request0_request_body_recurring_recurringExpiry = "2008/11/02 03:49:42";
		...
		Object request0_request_body_recurring_tokenService = "lowmost";
		...
		Object request0_request_body_shopperInteraction = "Ecommerce";
	...
	@Test
	public void test_post_getCostEstimate_20240411163503818()  throws JSONException{
		test0();
	}
}
