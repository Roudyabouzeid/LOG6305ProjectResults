...
@Order(67)
public class post_getCostEstimate_20240411163447369{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "BH19 RAFU S9HI ZMP7 YDN8 7U";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 5244266790445974759;
		...
		Object request0_request_body_merchantAccount = "d1";
		...
		Object request0_request_body_merchantDetails_countryCode = "BM";
		...
		Object request0_request_body_recurring_recurringDetailName = "fat-backed ME K";
	...
	@Test
	public void test_post_getCostEstimate_20240411163447369()  throws JSONException{
		test0();
	}
}
