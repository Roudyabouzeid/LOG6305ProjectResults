...
@Order(360)
public class post_getCostEstimate_20240411163515958{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "VAV";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 16;
		...
		Object request0_request_body_merchantAccount = "haeres LittB V a' ";
		...
		Object request0_request_body_selectedRecurringDetailReference = "bloodlike";
	...
	@Test
	public void test_post_getCostEstimate_20240411163515958()  throws JSONException{
		test0();
	}
}
