...
@Order(80)
public class post_getCostEstimate_20240411163447400{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "mom";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 1545759570700268800;
		...
		Object request0_request_body_assumptions_assume3DSecureAuthenticated = true;
		...
		Object request0_request_body_merchantAccount = "u49S-09TMaR_cm4KOmgv4CjXKDGwNyXVYtRAiSn01kmJmaO_SHg=";
		...
		Object request0_request_body_recurring_contract = "PAYOUT";
		...
		Object request0_request_body_recurring_recurringExpiry = "1712867632034";
		...
		Object request0_request_body_selectedRecurringDetailReference = "cheapskate";
	...
	@Test
	public void test_post_getCostEstimate_20240411163447400()  throws JSONException{
		test0();
	}
}
