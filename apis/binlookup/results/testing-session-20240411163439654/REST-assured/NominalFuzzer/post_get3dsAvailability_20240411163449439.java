...
@Order(100)
public class post_get3dsAvailability_20240411163449439{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_brands_brands0 = "At587M-tuYvGQ-ak33dLuQMHK8NxiGGD4plKFBPoY-ux6xzb_U-PW_EOFjnAG2NpORF-KvI29u_Xa6MpnEfBoEpSLXJ6d74MCsyKmEg=";
		request0_request_body_brands.put(request0_request_body_brands_brands0);
		Object request0_request_body_brands_brands1 = "breastfeeding";
		request0_request_body_brands.put(request0_request_body_brands_brands1);
		Object request0_request_body_brands_brands2 = "grown-up Dem";
		request0_request_body_brands.put(request0_request_body_brands_brands2);
		Object request0_request_body_brands_brands3 = "splenocolic";
		request0_request_body_brands.put(request0_request_body_brands_brands3);
		request0_request_body.put("brands" , request0_request_body_brands);
		Object request0_request_body_cardNumber = "D";
		request0_request_body.put("cardNumber" , request0_request_body_cardNumber);
		Object request0_request_body_merchantAccount = "carpet-smooth";
	...
	@Test
	public void test_post_get3dsAvailability_20240411163449439()  throws JSONException{
		test0();
	}
}
