...
@Order(274)
public class post_getCostEstimate_20240411163507884{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "891-83-263";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -5460369772505459690;
		...
		Object request0_request_body_merchantAccount = "23731-8514";
	...
	@Test
	public void test_post_getCostEstimate_20240411163507884()  throws JSONException{
		test0();
	}
}
