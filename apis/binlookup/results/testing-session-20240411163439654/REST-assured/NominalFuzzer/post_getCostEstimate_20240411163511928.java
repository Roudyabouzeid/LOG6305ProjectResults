...
@Order(303)
public class post_getCostEstimate_20240411163511928{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "9312048229";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 1848117452514937296;
		...
		Object request0_request_body_cardNumber = "white-waving";
		...
		Object request0_request_body_merchantAccount = "2007/06/22";
	...
	@Test
	public void test_post_getCostEstimate_20240411163511928()  throws JSONException{
		test0();
	}
}
