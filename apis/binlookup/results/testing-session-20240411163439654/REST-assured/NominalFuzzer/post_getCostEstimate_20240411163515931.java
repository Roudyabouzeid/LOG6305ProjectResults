...
@Order(343)
public class post_getCostEstimate_20240411163515931{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "bro";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -901014724004926677;
		...
		Object request0_request_body_merchantAccount = "BA66 6375 0167 8851 0411";
	...
	@Test
	public void test_post_getCostEstimate_20240411163515931()  throws JSONException{
		test0();
	}
}
