...
@Order(35)
public class post_getCostEstimate_20240411163442992{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "IHP";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 4921532216770709791;
		...
		Object request0_request_body_merchantAccount = "4870:2b2f:2980:f2df:1880:dcd8:1edb:ffb2";
		...
		Object request0_request_body_recurring_recurringExpiry = "1712867640827";
		request0_request_body_recurring.put("recurringExpiry" , request0_request_body_recurring_recurringExpiry);
		Object request0_request_body_recurring_recurringFrequency = "yellowroot";
	...
	@Test
	public void test_post_getCostEstimate_20240411163442992()  throws JSONException{
		test0();
	}
}
