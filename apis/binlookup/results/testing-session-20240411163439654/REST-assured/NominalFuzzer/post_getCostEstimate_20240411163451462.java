...
@Order(101)
public class post_getCostEstimate_20240411163451462{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "SC09 FVXV 4518 3500 9181 3239 2071 UWT";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 3078195256595046131;
		...
		Object request0_request_body_merchantAccount = "http://ennxr.qvqimc.io/back-pedal/";
		...
		Object request0_request_body_shopperReference = "+536287519954103";
	...
	@Test
	public void test_post_getCostEstimate_20240411163451462()  throws JSONException{
		test0();
	}
}
