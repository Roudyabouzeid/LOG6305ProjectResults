...
@Order(198)
public class post_getCostEstimate_20240411163459773{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "VSS";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 8262112920049352679;
		...
		Object request0_request_body_encryptedCardNumber = "lum@live.com";
		request0_request_body.put("encryptedCardNumber" , request0_request_body_encryptedCardNumber);
		Object request0_request_body_merchantAccount = "mensual";
		...
		Object request0_request_body_recurring_recurringExpiry = "http://ngdsca.zkywv.io/yHa_l-cJgXZdqNAOPKp8H4O_iRs1UWCzGI_OtJwRNVi1sg==/";
	...
	@Test
	public void test_post_getCostEstimate_20240411163459773()  throws JSONException{
		test0();
	}
}
