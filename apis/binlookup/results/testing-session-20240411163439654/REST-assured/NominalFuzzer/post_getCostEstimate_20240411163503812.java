...
@Order(230)
public class post_getCostEstimate_20240411163503812{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "NRA";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 89;
		...
		Object request0_request_body_encryptedCardNumber = "b49694";
		request0_request_body.put("encryptedCardNumber" , request0_request_body_encryptedCardNumber);
		Object request0_request_body_merchantAccount = "technicism";
		...
		Object request0_request_body_recurring_recurringExpiry = "2018/08/16 06:44:53";
		request0_request_body_recurring.put("recurringExpiry" , request0_request_body_recurring_recurringExpiry);
		Object request0_request_body_recurring_recurringFrequency = "+5109-20434741288";
	...
	@Test
	public void test_post_getCostEstimate_20240411163503812()  throws JSONException{
		test0();
	}
}
