...
@Order(160)
public class post_getCostEstimate_20240411163455580{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "Web";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -8508697516507996138;
		...
		Object request0_request_body_cardNumber = "agreat";
		...
		Object request0_request_body_merchantAccount = "18bc:22f4:5369:1770:82d4:c4e0:49ef:e432";
	...
	@Test
	public void test_post_getCostEstimate_20240411163455580()  throws JSONException{
		test0();
	}
}
