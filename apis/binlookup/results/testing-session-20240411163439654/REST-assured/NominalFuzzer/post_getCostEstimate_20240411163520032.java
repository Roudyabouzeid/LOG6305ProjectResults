...
@Order(383)
public class post_getCostEstimate_20240411163520032{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "5520177478";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -6773345826914907827;
		...
		Object request0_request_body_encryptedCardNumber = "Z ln";
		request0_request_body.put("encryptedCardNumber" , request0_request_body_encryptedCardNumber);
		Object request0_request_body_merchantAccount = "tenuifolious";
	...
	@Test
	public void test_post_getCostEstimate_20240411163520032()  throws JSONException{
		test0();
	}
}
