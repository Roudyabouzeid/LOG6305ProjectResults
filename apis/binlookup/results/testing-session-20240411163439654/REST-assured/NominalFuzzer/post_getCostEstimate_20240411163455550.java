...
@Order(145)
public class post_getCostEstimate_20240411163455550{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "UlD";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 6002663528072085932;
		...
		Object request0_request_body_merchantAccount = "MI";
	...
	@Test
	public void test_post_getCostEstimate_20240411163455550()  throws JSONException{
		test0();
	}
}
