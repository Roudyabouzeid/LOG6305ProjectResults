...
@Order(152)
public class post_getCostEstimate_20240411163455568{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "FAT";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -1596904287229477052;
		...
		Object request0_request_body_merchantAccount = "(+586) 00406567640";
		...
		Object request0_request_body_merchantDetails_mcc = "A.A.A.";
	...
	@Test
	public void test_post_getCostEstimate_20240411163455568()  throws JSONException{
		test0();
	}
}
