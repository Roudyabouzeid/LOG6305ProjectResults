...
@Order(359)
public class post_getCostEstimate_20240411163515956{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "IL22 0915 1651 9542 4435 864";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 193677820124088393;
		...
		Object request0_request_body_merchantAccount = "http://dqaf.r.com/cyclothure/";
		...
		Object request0_request_body_recurring_contract = "92b34894b2329d86";
		...
		Object request0_request_body_shopperReference = "6ea7d194-6796-483b-9ae3-fc068e1c9732";
	...
	@Test
	public void test_post_getCostEstimate_20240411163515956()  throws JSONException{
		test0();
	}
}
