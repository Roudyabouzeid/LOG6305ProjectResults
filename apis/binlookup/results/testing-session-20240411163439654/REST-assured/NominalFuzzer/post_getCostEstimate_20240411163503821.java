...
@Order(234)
public class post_getCostEstimate_20240411163503821{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "af02:30f3:4cac:5411:1cd9:82c8:50b1:244c";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 3077218197650401738;
		...
		Object request0_request_body_encryptedCardNumber = "suhuaro";
		request0_request_body.put("encryptedCardNumber" , request0_request_body_encryptedCardNumber);
		Object request0_request_body_merchantAccount = "URC ";
		...
		Object request0_request_body_recurring_recurringExpiry = "1712867789994";
		request0_request_body_recurring.put("recurringExpiry" , request0_request_body_recurring_recurringExpiry);
		Object request0_request_body_recurring_recurringFrequency = "awabi";
		...
		Object request0_request_body_selectedRecurringDetailReference = "a2493aae-305e-4dd5-9c8b-ddaaa5d74afe";
		...
		Object request0_request_body_shopperReference = "0010 9415994";
	...
	@Test
	public void test_post_getCostEstimate_20240411163503821()  throws JSONException{
		test0();
	}
}
