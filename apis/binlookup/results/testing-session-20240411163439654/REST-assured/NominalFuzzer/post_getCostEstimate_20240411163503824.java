...
@Order(236)
public class post_getCostEstimate_20240411163503824{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "LTA";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 6897722397210929953;
		...
		Object request0_request_body_encryptedCardNumber = "2013/07/01";
		request0_request_body.put("encryptedCardNumber" , request0_request_body_encryptedCardNumber);
		Object request0_request_body_merchantAccount = "Z";
	...
	@Test
	public void test_post_getCostEstimate_20240411163503824()  throws JSONException{
		test0();
	}
}
