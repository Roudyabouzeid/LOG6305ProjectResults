...
@Order(156)
public class post_getCostEstimate_20240411163455574{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "kit";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 586843089787084417;
		...
		Object request0_request_body_merchantAccount = "sisham";
	...
	@Test
	public void test_post_getCostEstimate_20240411163455574()  throws JSONException{
		test0();
	}
}
