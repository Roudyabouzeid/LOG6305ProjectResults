...
@Order(107)
public class post_getCostEstimate_20240411163451476{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "ANG";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 6417931901039880402;
		...
		Object request0_request_body_cardNumber = "7427:c243:fa32:8e6a:6ea0:d436:d363:5c78";
		request0_request_body.put("cardNumber" , request0_request_body_cardNumber);
		Object request0_request_body_encryptedCardNumber = "nonadjustability";
		request0_request_body.put("encryptedCardNumber" , request0_request_body_encryptedCardNumber);
		Object request0_request_body_merchantAccount = "searing";
		...
		Object request0_request_body_recurring_recurringExpiry = "2015/10/09 16:34:11";
	...
	@Test
	public void test_post_getCostEstimate_20240411163451476()  throws JSONException{
		test0();
	}
}
