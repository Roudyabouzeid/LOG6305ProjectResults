...
@Order(185)
public class post_getCostEstimate_20240411163459750{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "IQR";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 20;
		...
		Object request0_request_body_assumptions_assumeLevel3Data = true;
		...
		Object request0_request_body_merchantAccount = "semiphosphorescent";
		...
		Object request0_request_body_recurring_contract = "http://oguuiv.com/22zBj3RP91/";
		request0_request_body_recurring.put("contract" , request0_request_body_recurring_contract);
		Object request0_request_body_recurring_recurringDetailName = "noncuriosity";
		...
		Object request0_request_body_recurring_recurringFrequency = "diskettes";
		request0_request_body_recurring.put("recurringFrequency" , request0_request_body_recurring_recurringFrequency);
		Object request0_request_body_recurring_tokenService = "MCTOKENSERVICE";
	...
	@Test
	public void test_post_getCostEstimate_20240411163459750()  throws JSONException{
		test0();
	}
}
