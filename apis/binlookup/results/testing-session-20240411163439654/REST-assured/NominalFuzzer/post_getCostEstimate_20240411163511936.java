...
@Order(306)
public class post_getCostEstimate_20240411163511936{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "H o";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 113;
		...
		Object request0_request_body_merchantAccount = "MEX";
	...
	@Test
	public void test_post_getCostEstimate_20240411163511936()  throws JSONException{
		test0();
	}
}
