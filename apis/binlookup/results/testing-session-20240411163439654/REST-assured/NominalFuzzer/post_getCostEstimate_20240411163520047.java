...
@Order(392)
public class post_getCostEstimate_20240411163520047{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "UpO";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = -1984143263068262287;
		...
		Object request0_request_body_merchantAccount = "faucial";
		...
		Object request0_request_body_shopperReference = "2002/08/21";
	...
	@Test
	public void test_post_getCostEstimate_20240411163520047()  throws JSONException{
		test0();
	}
}
