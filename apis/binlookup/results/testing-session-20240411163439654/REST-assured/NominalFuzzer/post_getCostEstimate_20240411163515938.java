...
@Order(346)
public class post_getCostEstimate_20240411163515938{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "PPE";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 3842537492226631773;
		...
		Object request0_request_body_merchantAccount = "da38e655-9d74-4f4d-8ca5-1835db16078d";
		...
		Object request0_request_body_recurring_recurringExpiry = "2000/12/04 19:16:21";
		request0_request_body_recurring.put("recurringExpiry" , request0_request_body_recurring_recurringExpiry);
		Object request0_request_body_recurring_recurringFrequency = "faint";
		...
		Object request0_request_body_selectedRecurringDetailReference = "insaturable";
	...
	@Test
	public void test_post_getCostEstimate_20240411163515938()  throws JSONException{
		test0();
	}
}
