...
@Order(395)
public class post_getCostEstimate_20240411163520052{
...
String baseURL ="https://pal-test.adyen.com/pal/servlet/BinLookup/v54";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_amount_currency = "5So";
		request0_request_body_amount.put("currency" , request0_request_body_amount_currency);
		Object request0_request_body_amount_value = 3212040768704254442;
		...
		Object request0_request_body_assumptions_installments = -3037514;
		...
		Object request0_request_body_merchantAccount = "INC";
	...
	@Test
	public void test_post_getCostEstimate_20240411163520052()  throws JSONException{
		test0();
	}
}
