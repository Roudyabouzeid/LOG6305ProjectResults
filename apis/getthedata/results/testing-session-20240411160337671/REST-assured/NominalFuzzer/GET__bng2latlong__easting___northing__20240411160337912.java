...
@Order(14)
public class GET_/bng2latlong/{easting}/{northing}_20240411160337912{
...
String baseURL ="https://api.getthedata.com";
	...
	@Test
	public void test_GET_/bng2latlong/{easting}/{northing}_20240411160337912()  throws JSONException{
		test0();
	}
}
