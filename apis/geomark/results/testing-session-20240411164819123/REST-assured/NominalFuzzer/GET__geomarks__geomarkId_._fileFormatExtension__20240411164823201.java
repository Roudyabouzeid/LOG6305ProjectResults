...
@Order(39)
public class GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823201{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823201()  throws JSONException{
		test0();
	}
}
