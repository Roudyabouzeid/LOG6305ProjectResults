...
@Order(75)
public class GET_/geomarks/{geomarkId}/point.{fileFormatExtension}_20240411164829985{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}/point.{fileFormatExtension}_20240411164829985()  throws JSONException{
		test0();
	}
}
