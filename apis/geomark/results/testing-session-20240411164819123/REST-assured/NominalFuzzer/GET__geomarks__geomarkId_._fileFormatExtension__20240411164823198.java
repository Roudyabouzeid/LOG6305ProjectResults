...
@Order(35)
public class GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823198{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823198()  throws JSONException{
		test0();
	}
}
