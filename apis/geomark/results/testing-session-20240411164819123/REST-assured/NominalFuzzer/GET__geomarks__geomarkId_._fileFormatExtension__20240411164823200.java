...
@Order(38)
public class GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823200{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823200()  throws JSONException{
		test0();
	}
}
