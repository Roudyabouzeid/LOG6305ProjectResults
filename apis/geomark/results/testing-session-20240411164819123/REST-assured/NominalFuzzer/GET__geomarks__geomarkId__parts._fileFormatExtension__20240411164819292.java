...
@Order(8)
public class GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164819292{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164819292()  throws JSONException{
		test0();
	}
}
