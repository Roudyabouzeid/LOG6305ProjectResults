...
@Order(13)
public class GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164819301{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164819301()  throws JSONException{
		test0();
	}
}
