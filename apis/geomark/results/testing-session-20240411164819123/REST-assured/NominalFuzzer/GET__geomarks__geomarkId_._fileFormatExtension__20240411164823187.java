...
@Order(26)
public class GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823187{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823187()  throws JSONException{
		test0();
	}
}
