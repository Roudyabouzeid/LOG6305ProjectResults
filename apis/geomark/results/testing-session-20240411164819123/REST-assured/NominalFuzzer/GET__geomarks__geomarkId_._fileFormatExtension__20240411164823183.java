...
@Order(22)
public class GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823183{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823183()  throws JSONException{
		test0();
	}
}
