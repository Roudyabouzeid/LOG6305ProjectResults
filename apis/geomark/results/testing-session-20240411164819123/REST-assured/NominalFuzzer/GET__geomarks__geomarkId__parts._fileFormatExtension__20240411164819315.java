...
@Order(20)
public class GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164819315{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164819315()  throws JSONException{
		test0();
	}
}
