...
@Order(1)
public class GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164819263{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164819263()  throws JSONException{
		test0();
	}
}
