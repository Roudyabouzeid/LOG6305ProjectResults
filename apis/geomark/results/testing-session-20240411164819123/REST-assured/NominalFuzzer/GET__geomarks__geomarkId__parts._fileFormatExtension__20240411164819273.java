...
@Order(3)
public class GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164819273{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164819273()  throws JSONException{
		test0();
	}
}
