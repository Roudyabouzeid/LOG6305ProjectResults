...
@Order(21)
public class GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823182{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823182()  throws JSONException{
		test0();
	}
}
