...
@Order(23)
public class GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823184{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823184()  throws JSONException{
		test0();
	}
}
