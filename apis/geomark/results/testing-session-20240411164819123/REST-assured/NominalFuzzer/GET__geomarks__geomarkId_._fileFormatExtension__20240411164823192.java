...
@Order(31)
public class GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823192{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823192()  throws JSONException{
		test0();
	}
}
