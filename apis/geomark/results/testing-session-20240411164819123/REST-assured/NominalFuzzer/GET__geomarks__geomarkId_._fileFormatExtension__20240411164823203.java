...
@Order(40)
public class GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823203{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}.{fileFormatExtension}_20240411164823203()  throws JSONException{
		test0();
	}
}
