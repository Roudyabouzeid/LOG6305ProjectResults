...
@Order(157)
public class GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164846333{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164846333()  throws JSONException{
		test0();
	}
}
