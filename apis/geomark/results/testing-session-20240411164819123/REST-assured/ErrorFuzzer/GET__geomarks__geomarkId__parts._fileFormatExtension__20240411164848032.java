...
@Order(176)
public class GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164848032{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164848032()  throws JSONException{
		test0();
	}
}
