...
@Order(146)
public class GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164845025{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164845025()  throws JSONException{
		test0();
	}
}
