...
@Order(154)
public class GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164846060{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164846060()  throws JSONException{
		test0();
	}
}
