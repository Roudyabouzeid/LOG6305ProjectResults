...
@Order(142)
public class GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164844676{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164844676()  throws JSONException{
		test0();
	}
}
