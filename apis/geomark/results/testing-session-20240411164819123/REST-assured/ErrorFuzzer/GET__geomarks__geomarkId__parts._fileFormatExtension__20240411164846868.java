...
@Order(163)
public class GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164846868{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164846868()  throws JSONException{
		test0();
	}
}
