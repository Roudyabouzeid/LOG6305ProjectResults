...
@Order(141)
public class GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164844591{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164844591()  throws JSONException{
		test0();
	}
}
