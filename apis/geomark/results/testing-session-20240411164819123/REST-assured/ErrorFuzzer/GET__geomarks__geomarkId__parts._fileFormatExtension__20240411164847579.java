...
@Order(171)
public class GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164847579{
...
String baseURL ="https://apps.gov.bc.ca/pub/geomark";
	...
	@Test
	public void test_GET_/geomarks/{geomarkId}/parts.{fileFormatExtension}_20240411164847579()  throws JSONException{
		test0();
	}
}
